 ...
 * @date 01/01/2022
 */
public class ChangeTypeTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Declare and initialise a variable of a type int and then change the type of the variable into boolean :");
        String arg = "src/test/deca/context/invalid/custom/change_type.deca";
