 ...
 * @date 01/01/2022
 */
public class DeclIntTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Declaration of an integer and print it on the standard output :");
        String arg = "src/test/deca/context/valid/custom/Declaration/decl_int.deca";
