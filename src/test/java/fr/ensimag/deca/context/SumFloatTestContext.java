 ...
 * @date 01/01/2022
 */
public class SumFloatTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Program which print the sum of two floats :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/addition-floats.deca";
