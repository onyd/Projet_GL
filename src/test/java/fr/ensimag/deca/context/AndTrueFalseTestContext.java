 ...
 * @date 01/01/2022
 */
public class AndTrueFalseTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("the result of \"true && false\" on the standard output :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/and-true-false.deca";
