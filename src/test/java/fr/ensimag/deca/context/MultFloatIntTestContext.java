 ...
 * @date 01/01/2022
 */
public class MultFloatIntTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Multiplication between a float and an integer :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/multiplication-types-differents-float-int.deca";
