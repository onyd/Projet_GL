 ...
 * @date 01/01/2022
 */
public class MinusIntTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Change the sign of a positive int :");
        String arg = "src/test/deca/context/valid/custom/operation-unaire/minus-int.deca";
