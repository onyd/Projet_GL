 ...
 * @date 01/01/2022
 */
public class MultIntTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Multiplication between two ints :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/multiplication-ints.deca";
