 ...
 * @date 01/01/2022
 */
public class PrintStringTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Program which print a String :");
        String arg = "src/test/deca/context/valid/custom/affichage/print-string.deca";
