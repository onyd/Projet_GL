 ...
 * @date 01/01/2022
 */
public class OrTrueFalseTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Or operation between true and false :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/or-true-false.deca";
