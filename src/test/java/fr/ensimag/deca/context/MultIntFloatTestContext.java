 ...
 * @date 01/01/2022
 */
public class MultIntFloatTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Multiplication between an integer and a float :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/multiplication-types-differents-int-float.deca";
