 ...
 * @date 01/01/2022
 */
public class AffectIncompatibleTypeValueTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Affectation of a float on a int variable :");
        String arg = "src/test/deca/context/invalid/custom/affect-incompatible-type-value.deca";
