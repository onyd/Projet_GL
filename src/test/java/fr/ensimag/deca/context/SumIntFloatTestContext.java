 ...
 * @date 01/01/2022
 */
public class SumIntFloatTestContext {
    public static void main(String[] args) throws IOException {
        Logger.getRootLogger().setLevel(Level.DEBUG);
        DecaLexer lex;

        System.out.println("Program which print the sum of an integer and a float :");
        String arg = "src/test/deca/context/valid/custom/operation-binaires/addition-types-differents-int-float.deca";
